...
public class Main {
	...
	public  HashMap<Student,String> sortMapUsingStudentMarks(Map<Student,String> originalMap)
    {
    ...
    public static void main(String[] args) {
        ...
        Map<Student, String> sorted = main.sortMapUsingStudentMarks(hm);


        for(Entry<Student, String> stu : sorted.entrySet()) {
            
            System.out.println(stu.getValue().toString()+ " , "+ stu.getKey());
        }
    }
